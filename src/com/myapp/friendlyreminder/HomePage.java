...
public class HomePage extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/* Dont need to load content view as listview will do it */
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.history_menu:
			startActivity(new Intent("com.myapp.friendlyreminder.HISTORY"));
			return true;
		case R.id.settings_menu:
			startActivity(new Intent("com.myapp.friendlyreminder.SETTINGS"));
			return true;
		case R.id.add_item_menu:
			startActivity(new Intent("com.myapp.friendlyreminder.CREATE_REMINDER"));
			return true;
		case R.id.home_menu:
